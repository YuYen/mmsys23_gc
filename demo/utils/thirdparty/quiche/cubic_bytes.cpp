...
// new concurrent flows and speed up convergence.
        ...
        QuicByteCount CubicBytes::CongestionWindowAfterPacketLoss(
            ...
            SPDLOG_DEBUG("xxxxonlostxxxx : cwnd {}", current_congestion_window);
        ...
        QuicByteCount CubicBytes::CongestionWindowAfterAck(
            ...
            SPDLOG_DEBUG("on ack : cwnd {}", current_congestion_window);

            if (!epoch_.IsInitialized()) {
                // First ACK after a loss event.
                SPDLOG_DEBUG("Start of epoch");
...
//        QUICHE_DCHECK_LT(0u, estimated_tcp_congestion_window_);
            ...
            SPDLOG_DEBUG("Final target congestion_window: {}", target_congestion_window);
